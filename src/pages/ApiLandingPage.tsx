...
export default function ApiLandingPage({ onLogin }: ApiLandingPageProps) {
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <nav className="hidden md:flex items-center space-x-8">
              ...
              <a href="#documentacao" className="text-gray-600 hover:text-blue-600 transition-colors">Documentação</a>
      ...
      {/* Documentação */}
      <section id="documentacao" className="py-20 bg-gradient-to-br from-indigo-50 to-blue-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-4">
